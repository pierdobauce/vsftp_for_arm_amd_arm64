...
RUN echo "local_enable=YES" >> /etc/vsftpd/vsftpd.conf \
  ...
  && echo 'ftp_data_port=30200' >> /etc/vsftpd/vsftpd.conf \
  && echo 'pasv_enable=Yes' >> /etc/vsftpd/vsftpd.conf \
  && echo 'pasv_max_port=30101' >> /etc/vsftpd/vsftpd.conf \
  && echo 'pasv_min_port=30100' >> /etc/vsftpd/vsftpd.conf \
